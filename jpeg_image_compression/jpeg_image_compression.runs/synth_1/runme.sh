...
HD_PWD='C:/Users/hp/Documents/FGPA/mini_project/jpeg_image_compression/jpeg_image_compression.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_jpeg_compression.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_jpeg_compression.tcl

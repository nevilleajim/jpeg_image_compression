...
HD_PWD='C:/Users/hp/Documents/FGPA/mini_project/jpeg_image_compression/jpeg_image_compression.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_jpeg_compression.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module_jpeg_compression.tcl -notrace

...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 62256);
	iki_vhdl_file_variable_register(dp + 62312);
	iki_vhdl_file_variable_register(dp + 69280);
	iki_vhdl_file_variable_register(dp + 69400);
	iki_vhdl_file_variable_register(dp + 69520);
	iki_vhdl_file_variable_register(dp + 69640);
